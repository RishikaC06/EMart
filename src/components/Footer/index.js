  ...
  return (
        <footer className="text-gray-600 body-font border border-t-2">
            <div className="container px-5 py-8 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <p className="mt-2 text-sm text-gray-500">One stop destination for all your clothes, accessories and electronics</p>
                </div>
            ...
            <div className="bg-gray-100">
                ...
                <p className="text-gray-500 text-sm text-center sm:text-left">© EMart —
                    <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@www.emart.com</a>
                </p>
